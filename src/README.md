...
| <a name="module_kms_key_ses"></a> [kms\_key\_ses](#module\_kms\_key\_ses) | cloudposse/kms-key/aws | 0.12.2 |
| <a name="module_ses"></a> [ses](#module\_ses) | cloudposse/ses/aws | 0.25.1 |
...
| <a name="input_domain_template"></a> [domain\_template](#input\_domain\_template) | The `format()` string to use to generate the base domain name for sending and receiving email with Amazon SES, `format(var.domain_template, var.tenant, var.environment, var.stage)` | `string` | n/a | yes |
